...
for learningrate in learningrates:
    ...
    for i in range(len(trainfolds)):
        ...
        w_all, w_best, totalnumberofmistakes, accsfe= averaged_perceptron(train_set_X,train_set_y,test_set_X,test_set_y,learningrate,epochs)
        acc=np.mean(accsfe)
...
learningrate=0.01
epochs=20
w_all, w_best, numofmistakes, accs=averaged_perceptron(X_train,y_train,X_test,y_test,learningrate,epochs)
